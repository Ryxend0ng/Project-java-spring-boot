 ...
 <div class="main_gener">
         <div class="list_gener">
            <ul>
                ...
                <li>
                    <a class="active"   href="/hai-huoc">Hài Hước</a>
                </li>
                <li>
                ...
                <div class="introduce-comic">
                    <div class="item item1">
                        <a href="../html/ThongTin.html">
                            ...
                            <img src="${pageContext.request.contextPath}/template/web/image/hh1.PNG" alt="">
                    ...
                    <div class="item">
                        <a href="../html/ThongTin.html">
                            ...
                            <img src="${pageContext.request.contextPath}/template/web/image/hh2.PNG" alt="">
                    ...
                    <div class="item item3">
                        <a href="../html/ThongTin.html">
                            ...
                            <img src="${pageContext.request.contextPath}/template/web/image/hh3.PNG" alt="">
                    ...
                    <div class="item item4">
                        <a href="../html/ThongTin.html">
                            <div class="title-comic">
                                <p>Tương lai của thánh</p>
                                <div class="view"><i class="fa fa-heart" aria-hidden="true"></i>999.4K
                                </div>
                                <div class="up">up</div>

                            </div>
                            <img src="${pageContext.request.contextPath}/template/web/image/hh4.PNG" alt="">
                    ...
                    <div class="item item5">
                        <a href="../html/ThongTin.html">
                            <div class="title-comic">
                                <p>Mặt trăng mùa đông</p>
                                <div class="view"><i class="fa fa-heart" aria-hidden="true"></i>1.9M
                                </div>
                                <div class="up">up</div>

                            </div>
                            <img src="${pageContext.request.contextPath}/template/web/image/hh5.PNG" alt="">
                    ...
                    <div class="item item6">
                        <a href="../html/ThongTin.html">
                            ...
                            <img src="${pageContext.request.contextPath}/template/web/image/hh6.PNG" alt="">

                            <div class="comic-thumnail" id="bg-green">
                                <p>Nụ cười bẫ</p>
                    ...
                    <div class="item item7">
                        <a href="../html/ThongTin.html">
                            <div class="title-comic">
                                <p>Âm thanh của trái tim</p>
                                <div class="view"><i class="fa fa-heart" aria-hidden="true"></i>2.1M
                                </div>
                                <div class="up">up</div>

                            </div>
                            <img src="${pageContext.request.contextPath}/template/web/image/hh7.PNG" alt="">
                    ...
                    <div class="item item8">
                        <a href="../html/ThongTin.html">
                            ...
                            <img src="${pageContext.request.contextPath}/template/web/image/hh8.PNG" alt="">
                    ...
                    <div class="item item9">
                        <a href="../html/ThongTin.html">
                            ...
                            <img src="${pageContext.request.contextPath}/template/web/image/hh10.PNG" alt="">
