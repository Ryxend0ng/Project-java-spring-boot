			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<sf:form action="${base }/admin/edit-roles"  id="formSubmit" 
						method="POST" >
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="status"
										name="status" value="${roles.status}" />
								</div>
							</div>
							<br /> <br />
							
								<input type="hidden" value="${roles.id}" id="id" name="id" />
    ...
    function updateNew() {
        ...
        $.ajax({
            ...
            success: function (jsonResult) {
            	alert("Chúc mừng!!! Đã lưu thành công role :"+jsonResult.message.name);
            },
