...
import com.ryxen.exception.BadRequestException;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private BlidingProperties appProperties;

    private HttpCookieOAuth2AuthorizationRequestRepository httpCookieOAuth2AuthorizationRequestRepository;
    public static final String REDIRECT_URI_PARAM_COOKIE_NAME = "redirect_uri";

    @Autowired
    OAuth2AuthenticationSuccessHandler(JwtTokenProvider tokenProvider, BlidingProperties appProperties,
...
//    	FacebookOAuth2UserInfo fb=(FacebookOAuth2UserInfo) authentication.getPrincipal();
